...
const ENTITY_PATTERNS: Array<{ type: string; regex: RegExp; normalizer: (match: string) => string }> = [
  ...
  {
    type: "industry",
    regex: /\b(fashion|technology|tech|health|fitness|finance|fintech|food|restaurant|travel|education|real estate|automotive|music|entertainment|gaming|sports|art|photography|law|consulting|marketing|saas|ecommerce|retail|beauty|wellness|yoga|meditation|crypto|blockchain|ai|startup|agency|design|architecture|interior|product|service|nonprofit|ngo|government|community|blog|news|magazine|journal|portfolio)\b/gi,
    normalizer: (m) => m.toLowerCase(),
  },
  {
    type: "audience",
