...
const NICHE_DEFAULT_GROUPS: Array<{ match: string[]; defaults: NicheDefaults }> = [
  ...
  { match: ["fashion", "streetwear", "apparel", "clothing", "boutique", "beauty"],
    defaults: { visualMood: "warm", designStyle: "editorial", websitePersonality: "bold", businessTone: "casual", conversionStyle: "product-first", layoutDirection: "e-commerce", visualDensity: "airy", animationExpectation: "moderate", imageDirection: "photography-heavy", compositionExpectation: "magazine" } },
  { match: ["ecommerce", "retail"],
    defaults: { visualMood: "muted", designStyle: "minimal", websitePersonality: "bold", conversionStyle: "product-first", layoutDirection: "e-commerce", visualDensity: "balanced", animationExpectation: "subtle", imageDirection: "photography-heavy" } },
  { match: ["photography", "photographer", "portfolio", "art"],
    defaults: { visualMood: "dramatic", designStyle: "minimal", websitePersonality: "sophisticated", conversionStyle: "story-driven", layoutDirection: "portfolio", visualDensity: "sparse", animationExpectation: "scroll-driven", imageDirection: "photography-heavy", compositionExpectation: "magazine" } },
  { match: ["design", "architecture", "interior", "studio"],
    defaults: { visualMood: "cold", designStyle: "minimal", websitePersonality: "sophisticated", layoutDirection: "portfolio", visualDensity: "sparse", animationExpectation: "scroll-driven", imageDirection: "photography-heavy", compositionExpectation: "asymmetric" } },
  ...
  { match: ["agency", "marketing", "advertising", "branding"],
    defaults: { visualMood: "dark", designStyle: "editorial", websitePersonality: "bold", businessTone: "disruptive", conversionStyle: "story-driven", layoutDirection: "showcase", visualDensity: "airy", animationExpectation: "moderate", compositionExpectation: "asymmetric" } },
