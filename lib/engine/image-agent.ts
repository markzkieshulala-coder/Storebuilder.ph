...
// NOTE: This engine NEVER sources images from a third party (no Unsplash,
// Pexels, stock APIs, or shared CDN). Images come only from in-house sources:
// the self-hosted diffusion generator (real photographs) or the in-process
// canvas/SVG visual engine. The former curated-Unsplash-ID library and its
// helpers were removed to keep that guarantee airtight.
