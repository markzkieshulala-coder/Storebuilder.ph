...
export interface MutationResult {
  ...
  warnings: string[];
  errors: string[];
  // The fully mutated input (layout graph + visual system) the renderer should use.
  mutatedInput?: DiversityEngineInput;
}
...
export interface DiversityCheckResult {
  ...
  // The mutated input the renderer should use when a mutation was applied.
  // Undefined when the generation was already diverse (use the original input).
  mutatedInput?: DiversityEngineInput;
