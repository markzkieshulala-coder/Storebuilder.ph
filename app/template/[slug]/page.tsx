      ...
      <main className="bg-white relative">
        {template.thumbnail ? (
          <div className="w-full overflow-hidden" style={{ maxHeight: "70vh" }}>
            ...
            />
            {!session && (
              <TemplateSignupGate slug={slug || ""} templateName={template.name} />
            )}
          </div>
        ) : (
...
// Sign-up gate overlay shown over thumbnail previews for unauthenticated visitors.
function TemplateSignupGate({ slug, templateName }: { slug: string; templateName: string }) {
  return (
    <div
    ...
    >
      <div className="max-w-md mx-auto px-6 py-12 sm:py-16 text-center">
        <div
        ...
        <p className="text-sm text-gray-500 mb-5 leading-relaxed">
          Create a free Storebuilder.ph account to use{" "}
          <strong className="text-gray-700">{templateName}</strong> in your dashboard.
        </p>
